...
the interface folder contains the definition of the binary protocol interface
and the binary commands.
...
- [protocol encryption](./protocol-encryption.md) describe encryption of
  protocol payloads
