...
- [set_key](../../reference-guides/commands/set_key)
...
These commands must be sent encrypted even when `unlock_session` has temporarily enabled unencrypted messages or the `require_transport_encryption` command has permanentely disabled this feature.
