...
uint32_t FakeCryptoHandler::checksum(uint8_t length, uint8_t* buffer) { return 0x33333333; }

uint32_t FakeCryptoHandler::mac(uint8_t length, uint8_t* buffer) { return 0x01234567; }
