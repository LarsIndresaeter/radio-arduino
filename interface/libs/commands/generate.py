...
generateFile("gpio", [], ["portB", "portC", "portD"], ["stdint.h"])
...
generateFile("quadrature_encoder", [], ["cnt_neg_high", "cnt_neg_low", "cnt_pos_high", "cnt_pos_low", "sw_pos", "sw_cnt_high", "sw_cnt_low", "status"], ["stdint.h"])
generateFile("radio_uart", ["mode"], ["status"], ["stdint.h"])
...
generateFile("sleep", ["delay_0", "delay_1", "delay_2", "delay_3"], ["status"], ["stdint.h"])
...
generateFile("wakeup", ["check_attention_flag"], ["status", "attention"], ["stdint.h"])
