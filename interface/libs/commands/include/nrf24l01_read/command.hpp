...
public:
    UartCommandNrf24l01Read(std::vector<uint8_t> data)
            ...
            COMMANDS::NRF24L01_READ::COMMAND_LENGTH)
    {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            m_payload.at(offsetof(COMMANDS::NRF24L01_READ::command_t, data[0]) + i)
                = data.at(i);
        }
    };
    ...
    std::string getString()
    {
        ...
        COMMANDS::NRF24L01_READ::response_t r = responseStruct();
