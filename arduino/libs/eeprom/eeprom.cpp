...
void increamentSpareVersion()
{
    ...
    EEPROM::readMultiple(
        offsetSpareStruct() + offsetof(eeprom_data_t, dataVersion), (uint8_t*)&dataVersion, sizeof(uint32_t));
...
void findActivePartition()
{
    ...
    EEPROM::readMultiple(
        offsetof(full_eeprom_t, A) + offsetof(eeprom_data_t, dataVersion), (uint8_t*)&dataVersionA, sizeof(uint32_t));
    EEPROM::readMultiple(
        offsetof(full_eeprom_t, B) + offsetof(eeprom_data_t, dataVersion), (uint8_t*)&dataVersionB, sizeof(uint32_t));
...
void incrementRestarts()
{
    ...
    EEPROM::writeMultiple(
        offsetSpareStruct() + offsetof(eeprom_data_t, restarts), (uint8_t*)&restarts, sizeof(uint16_t));
    calculateCrcAndSetSpareAsActive();
}
